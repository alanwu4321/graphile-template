...
export DATABASE_URL="postgres://${DATABASE_OWNER}:fuckthis@${DATABASE_HOST}/${DATABASE_NAME}"
export AUTH_DATABASE_URL="postgres://${DATABASE_AUTHENTICATOR}:fuckthis@${DATABASE_HOST}/${DATABASE_NAME}"
